...
app.controller('mainCtrl', function($scope, $rootScope, $location, appSocket) {
    ...
    $scope.enter_code = function() {
        if ((code=prompt('Your code is: ' + $scope.secret_code + '\n\nEnter the secret code of your dancing partner to earn points!\n\nIf you enter an incorrect code, you get a penalty point.ogou'))) {
            socket.call('disco_guess', {code: code}).then(function(r) {
                alert(r);
            });
        }
    };
